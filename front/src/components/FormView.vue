      ...
      <v-container>
        <v-row>
          ...
          >
            ...
            <input type="date" placeholder="Start from" class="date" v-model="startDate"/>
          </v-col>
          <v-col
            cols="12"
            sm="6"
          ...
          >
            ...
            <input type="date" placeholder="Start from" class="date" v-model="endDate"/>
          </v-col>
          <v-col
            cols="12"
            sm="6"
          >
            ...
            sm="12"
          >
          <span for="">Duration: <span>3</span> days</span>
          </v-col>
          <v-col
            cols="12"
            md="12"
