<template>
    <!-- <div style="width: 50%;margin: auto;margin-top: 20px;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;border-top: 10px solid rgb(212, 236, 249);border-radius: 10px;"> -->
    <div class="w-50 mx-auto my-3" elevation="4">
      <div style="margin: auto;display: flex;justify-content: center;background: rgb(212, 236, 249);">
        <!-- REAL IMAGE -->
        <div class="top-content">
          <h2 class="mt-5 mb-3">Personal Profile</h2>
            <img :src="users.image !=null?users.image:avataImage" alt="" width="150" height="150" style="border-radius: 50%;">
            <div class="update">
              <label for="images">
                <v-icon class="ml-15">mdi-camera</v-icon>
              </label>
        ...
        <div class="info-detail mt-5" v-if="!ishidden">
