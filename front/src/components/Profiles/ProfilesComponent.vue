    ...
    <div class="profiles-container">
      ...
      <div class="top-content">
        ...
        <div class="info-detail" v-if="!ishidden">
          <div class="name-defualt">
            <div>STUDENT ID</div>
            <div class="getinfo"><strong>{{users.personal_id}}</strong></div>
          </div>
        </div>
        <!-- PHONE NUMBER-->
        <div class="info-detail" v-if="!ishidden">
...
export default ({
  ...
  methods: {
    ...
    onUpload(image){
        ...
        fd.append('firstName', this.users.firstName)
        fd.append('lastName', this.users.lastName)
        fd.append('email', this.users.email)
        fd.append('password', this.users.password)
  ...
  computed: {
     showAndHidePersonalData() {
      //  console.log(this.users.image)
        return this.users.image != "" || null 
    },
  }
